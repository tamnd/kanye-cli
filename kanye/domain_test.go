...
// HTTP behaviour is covered in kanye_test.go.
...
func TestDomainInfo(t *testing.T) {
	...
	if info.Identity.Binary != "kanye" {
		t.Errorf("Identity.Binary = %q, want kanye", info.Identity.Binary)
	}
}
...
func TestHostWiring(t *testing.T) {
	...
	if want := "kanye://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("kanye", "about")
	if err != nil || got.String() != "kanye://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want kanye://page/about", got.String(), err)
	}
}
