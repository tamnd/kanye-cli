...
Most of these come down to network reality or how kanye serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

kanye rate-limits like any public site. kanye already paces
...
Where a surface is gated, kanye reads a cookie or token you supply
...
`kanye`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what kanye actually did
